/**
 * Seed script — creates two manager accounts.
 * Run from the repo root:
 *   npx ts-node -r tsconfig-paths/register apps/auth-service/src/seed-managers.ts
 * Or simply:
 *   npx ts-node apps/auth-service/src/seed-managers.ts
 */
